const site = {
  ...
  siteOrigin: process.env.SITE_ORIGIN || process.env.PUBLIC_SITE_ORIGIN || 'https://shengjingjc.com',
  contentUpdatedAt: '2026-06-24',
  defaultTitle: '晟景装饰｜交城装修公司与交城装饰公司透明工地服务',
  defaultDescription: '晟景装饰服务山西吕梁交城本地业主，是可对比了解的交城装修公司和交城装饰公司，提供新房装修、旧房改造、老房翻新、整装设计、全屋定制和透明工地施工管理服务。通过施工日报、现场照片、节点验收和售后记录，让装修过程更清楚。',
  ...
  services: ['新房装修', '旧房改造', '老房翻新', '婚房装修', '整装服务', '半包 / 全包', '全屋定制', '售后维修'],
